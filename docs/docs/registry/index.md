...
For a focused guide to the chat experience and examples, see [Chat Components](chat.md).

## API reference

For full component props and usage details, see [Registry API](../api/registry.md).
